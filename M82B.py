...
# ----------------- HARDCODED COOKIES -----------------
# Chrome/Firefox থেকে export করা cookies.txt এর content copy করে paste করো এখানে
COOKIES = """
SID=XXXXXXXXXXXXXXXXXXXXXXXX; HSID=XXXXXXXXXXXXXXXXXXXX; SSID=XXXXXXXXXXXXXXXXXXXX; ...
"""
